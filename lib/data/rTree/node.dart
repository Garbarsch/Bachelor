...
abstract class Node<E> extends RRect {
 ...
 late  Node<E>? parent;
  ...
  addChild(covariant RRect child) {
    include(child);
    children.add(child);
  }

  /// Removes [child] from this node
  removeChild(covariant RRect child) {
  ...
  Node<E> _split() {
    ...
    List<RRect> remainingChildren = children;
  ...
  _reassignRemainingChildren(
      List<RRect> remainingChildren, Node<E> splitNode) {
  ...
  _Seeds _pickSeeds() {
    ...
    RRect leftmost = children.elementAt(0);
    RRect rightmost = children.elementAt(0);
    RRect topmost = children.elementAt(0);
    RRect bottommost = children.elementAt(0);
